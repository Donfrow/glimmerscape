void trap_door shape#(1395)()      // opens and closes the trap door shape in conjunction with trap_door_open
{
...
void trap_door_key shape#(1477)()
{
	if(event == DOUBLECLICK)
	{
		...
		else if (target_shape == 1395)
		{
			UI_set_item_shape(target[1], 1476);
		}
	}
}
